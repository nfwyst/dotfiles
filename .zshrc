...
function run_qwen_agent() {
  python3.10 run_server.py --llm deepseek-ai/DeepSeek-R1 --model_server https://api.hyperbolic.xyz/v1 --workstation_port 7864 --api_key "$HYPERBOLIC_API_KEY" --max_ref_token 89429
}
