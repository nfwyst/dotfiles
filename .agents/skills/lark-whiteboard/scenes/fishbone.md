...
- **脚本生成坐标**（必须）：用 .js 脚本通过三角函数计算鱼骨坐标，脚本输出 JSON 文件后调用 `bunx -y @larksuite/whiteboard-cli@^0.1.0` 渲染
...
bunx -y @larksuite/whiteboard-cli@^0.1.0 -i fishbone.json -o ./fishbone.png
```
