...
- **脚本生成坐标**（必须）：用 .js 脚本极坐标计算阶段标签位置、SVG 圆环切割，脚本输出 JSON 文件后调用 `bunx -y @larksuite/whiteboard-cli@^0.1.0` 渲染
...
bunx -y @larksuite/whiteboard-cli@^0.1.0 -i flywheel.json -o ./flywheel.png
```
