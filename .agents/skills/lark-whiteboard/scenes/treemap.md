...
- **脚本生成坐标**（推荐）：Treemap 需要精确的面积比例计算，用 .js 脚本递归切分矩形，脚本输出 JSON 文件后调用 `bunx -y @larksuite/whiteboard-cli@^0.1.0` 渲染
- 不适合手动心算坐标
...
bunx -y @larksuite/whiteboard-cli@^0.1.0 -i treemap.json -o ./treemap.png
```
