...
- **脚本生成坐标**（推荐）：用 .js 脚本计算数据点坐标和折线路径，脚本输出 JSON 文件后调用 `bunx -y @larksuite/whiteboard-cli@^0.1.0` 渲染
...
bunx -y @larksuite/whiteboard-cli@^0.1.0 -i line-chart.json -o ./line-chart.png
```
